...
{
  "$end", "error", "$undefined", "CREATE", "TABLE", "IDENT", "'('", "')'",
  "';'", "','", "$accept", "create_stmt", "columndef_list", "column_def",
  "tablename", "attr_name", "attr_type", YY_NULLPTR
};
#endif
...
{
      12,     1,    13,     3,     4,     5,     0,     7,     8,    17,
      14,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       7,     3,     9,     4,     0,     5,    -1,     6,     5,    13,
       5,    -1,    -1,    -1,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 28 "sqlgram.y" /* yacc.c:1646  */
    {
                        ParserTree* parserTree = (ParserTree*)yyget_extra(yyscaninfo);
                        CreateStmt* createStmt = NewNode(CreateStmt);
                        createStmt->tableName = (yyvsp[-4].sval);
                        createStmt->colList = (yyvsp[-2].node);

                        parserTree->root = (Node*)createStmt;
                        parserTree->result = 0;
                    }
#line 1228 "sqlgram.c" /* yacc.c:1646  */
    break;

  case 3:
#line 39 "sqlgram.y" /* yacc.c:1646  */
    {
                        (yyval.node) = AppendNewList((yyvsp[0].node));
                    }
#line 1236 "sqlgram.c" /* yacc.c:1646  */
    break;

  case 4:
#line 43 "sqlgram.y" /* yacc.c:1646  */
    {
                        (yyval.node) = AppendList((yyvsp[-2].node), (yyvsp[0].node));
                    }
#line 1244 "sqlgram.c" /* yacc.c:1646  */
    break;
...
#line 1255 "sqlgram.c" /* yacc.c:1646  */
    break;
...
#line 1263 "sqlgram.c" /* yacc.c:1646  */
    break;
...
#line 1271 "sqlgram.c" /* yacc.c:1646  */
    break;
...
#line 1279 "sqlgram.c" /* yacc.c:1646  */
    break;
