...
ValuesData* GetColumnData(Node *col, Node *resList)
{
    ...
    switch(col->type)
    {
        ...
        case T_TargetElement:
            resValue = FetchValuesData(col, resList);
        break;
        default:
        break;
    }
...
ValuesData* boolAndOperator(ValuesData* leftvalue, ValuesData* rightvalue)
{
    int first = 0;
    int seconde = 0;
    int result = 0;
    ...
    first = leftvalue->dataVal.iData;
    seconde = rightvalue->dataVal.iData;
...
ValuesData* boolOrOperator(ValuesData* leftvalue, ValuesData* rightvalue)
{
    int first = 0;
    int seconde = 0;
    int result = 0;
...
ValuesData* boolNotOperator(ValuesData* leftvalue, ValuesData* rightvalue)
{
    int first = leftvalue->dataVal.iData;
    int seconde = rightvalue->dataVal.iData;
    int result = 0;
...
ValuesData* ComputeExpr(Expr_Op opType, ValuesData *lres, ValuesData *rres)
{
    ...
    {
        printf("DataType or Operator is not supported.(%d-%d)\n", opType, lres->dataType);
    }
