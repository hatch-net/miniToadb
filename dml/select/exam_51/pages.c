...
ValuesData* FormCol2ValueData(AttrInfo *attr, ColumnDataHeader* colDataHeader)
{
    int colDataSize = sizeof(ColumnDataHeader);
    char *colData = (char *)colDataHeader;
    ValuesData *value = NewNode(ValuesData);
    ...
    {
        char *val = (char *)(colData + colDataSize);
        value->dataType = DT_CHAR;
        value->dataVal.cData = *val;
    }
    break;
    ...
    {
        char *val = (char *)(colData + colDataSize);
        value->dataType = DT_VARCHAR;
        value->dataVal.pData = (char*)malloc(colDataHeader->size - colDataSize);
        strncpy(value->dataVal.pData, val, colDataHeader->size - colDataSize);    
    }
    break;
