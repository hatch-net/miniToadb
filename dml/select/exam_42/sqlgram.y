...
%type <ival> target_opts left_or_right left_or_right_opt outer_opt inner_cross_join_opt
...
%type <node> where_clause a_expr c_expr column_name
...
table_ref: table_info 
    ...
    ;
table_info: column_name alias_opt
            {                
